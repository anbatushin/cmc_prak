...
class App:
    def __init__(self, WIDTH=800, HEIGHT=600, CELL_SIZE=2):
        pg.init()
        ...
        self.ants = [Ant(self, [randrange(self.COLS), randrange(self.ROWS)], self.get_color()) for i in range(randrange(10))]
